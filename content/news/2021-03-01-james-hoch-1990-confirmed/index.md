...
Mäder will try to integrate this latest finding into a forthcoming article on the current state of the Byblos script. The matches are extremely promising, because they a) could lead the path to internal (linguistic) confirmation of the suspicions provided in the list above, and with that, serve as a late justification of the prudent, methodically soberly executed, and simply ingenious approaches by Sobelman (1961) and Hoch (1990).
...
**Mäder, Michael (forthcoming):** "Lautwertvorschläge zum Byblos-Syllabar anhand der ersten bekannten Bigraphe." (Submitted to Ägypten und Levante)
